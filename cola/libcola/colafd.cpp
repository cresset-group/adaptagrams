...
ProjectionResult projectOntoCCs(Dim dim, vpsc::Rectangles &rs, CompoundConstraints ccs,
...
ProjectionResult solve(Variables &vs, Constraints &cs, vpsc::Rectangles &rs, unsigned debugLevel)
{
    int result = 0;
